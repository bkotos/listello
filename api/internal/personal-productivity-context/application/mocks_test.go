...
// NewMockItemQueryRepository creates a new instance of MockItemQueryRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockItemQueryRepository(t interface {
	mock.TestingT
	Cleanup(func())
...
// MockItemQueryRepository is an autogenerated mock type for the ItemQueryRepository type
type MockItemQueryRepository struct {
	mock.Mock
}

type MockItemQueryRepository_Expecter struct {
	mock *mock.Mock
}

func (_m *MockItemQueryRepository) EXPECT() *MockItemQueryRepository_Expecter {
	return &MockItemQueryRepository_Expecter{mock: &_m.Mock}
}

// GetComments provides a mock function for the type MockItemQueryRepository
func (_mock *MockItemQueryRepository) GetComments(listID string) ([]viewmodel.ItemComment, error) {
...
// MockItemQueryRepository_GetComments_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetComments'
type MockItemQueryRepository_GetComments_Call struct {
	*mock.Call
}

// GetComments is a helper method to define mock.On call
//   - listID string
func (_e *MockItemQueryRepository_Expecter) GetComments(listID any) *MockItemQueryRepository_GetComments_Call {
	return &MockItemQueryRepository_GetComments_Call{Call: _e.mock.On("GetComments", listID)}
}

func (_c *MockItemQueryRepository_GetComments_Call) Run(run func(listID string)) *MockItemQueryRepository_GetComments_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockItemQueryRepository_GetComments_Call) Return(itemComments []viewmodel.ItemComment, err error) *MockItemQueryRepository_GetComments_Call {
	_c.Call.Return(itemComments, err)
	return _c
}

func (_c *MockItemQueryRepository_GetComments_Call) RunAndReturn(run func(listID string) ([]viewmodel.ItemComment, error)) *MockItemQueryRepository_GetComments_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockItemRepository) Delete(id string) error {
	ret := _mock.Called(id)
...
//   - id string
func (_e *MockItemRepository_Expecter) Delete(id any) *MockItemRepository_Delete_Call {
	return &MockItemRepository_Delete_Call{Call: _e.mock.On("Delete", id)}
}

func (_c *MockItemRepository_Delete_Call) Run(run func(id string)) *MockItemRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockItemRepository_Delete_Call) RunAndReturn(run func(id string) error) *MockItemRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockItemRepository) GetByID(id string) (domain.Item, error) {
	ret := _mock.Called(id)
...
//   - id string
func (_e *MockItemRepository_Expecter) GetByID(id any) *MockItemRepository_GetByID_Call {
	return &MockItemRepository_GetByID_Call{Call: _e.mock.On("GetByID", id)}
}

func (_c *MockItemRepository_GetByID_Call) Run(run func(id string)) *MockItemRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockItemRepository_GetByID_Call) RunAndReturn(run func(id string) (domain.Item, error)) *MockItemRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockListRepository_Delete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Delete'
type MockListRepository_Delete_Call struct {
	*mock.Call
}
...
func (_c *MockListRepository_Delete_Call) Return(err error) *MockListRepository_Delete_Call {
	_c.Call.Return(err)
	return _c
}
...
// GetByID provides a mock function for the type MockSpaceRepository
func (_mock *MockSpaceRepository) GetByID(id string) (domain.Space, error) {
	ret := _mock.Called(id)
...
// MockSpaceRepository_GetByID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByID'
type MockSpaceRepository_GetByID_Call struct {
	*mock.Call
}

// GetByID is a helper method to define mock.On call
//   - id string
func (_e *MockSpaceRepository_Expecter) GetByID(id any) *MockSpaceRepository_GetByID_Call {
	return &MockSpaceRepository_GetByID_Call{Call: _e.mock.On("GetByID", id)}
}

func (_c *MockSpaceRepository_GetByID_Call) Run(run func(id string)) *MockSpaceRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockSpaceRepository_GetByID_Call) Return(space domain.Space, err error) *MockSpaceRepository_GetByID_Call {
	_c.Call.Return(space, err)
	return _c
}

func (_c *MockSpaceRepository_GetByID_Call) RunAndReturn(run func(id string) (domain.Space, error)) *MockSpaceRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function for the type MockSpaceRepository
func (_mock *MockSpaceRepository) Save(space domain.Space) error {
	ret := _mock.Called(space)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(domain.Space) error); ok {
		r0 = returnFunc(space)
	} else {
		r0 = ret.Error(0)
	}
...
// MockSpaceRepository_Save_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Save'
type MockSpaceRepository_Save_Call struct {
	*mock.Call
}

// Save is a helper method to define mock.On call
//   - space domain.Space
func (_e *MockSpaceRepository_Expecter) Save(space any) *MockSpaceRepository_Save_Call {
	return &MockSpaceRepository_Save_Call{Call: _e.mock.On("Save", space)}
}

func (_c *MockSpaceRepository_Save_Call) Run(run func(space domain.Space)) *MockSpaceRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 domain.Space
		if args[0] != nil {
			arg0 = args[0].(domain.Space)
		}
		run(
			arg0,
		)
...
func (_c *MockSpaceRepository_Save_Call) Return(err error) *MockSpaceRepository_Save_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockSpaceRepository_Save_Call) RunAndReturn(run func(space domain.Space) error) *MockSpaceRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockUserRepository) GetByID(id string) (domain.User, error) {
	ret := _mock.Called(id)
...
func (_c *MockUserRepository_GetByID_Call) RunAndReturn(run func(id string) (domain.User, error)) *MockUserRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// Save provides a mock function for the type MockUserRepository
func (_mock *MockUserRepository) Save(user domain.User) error {
...
// Save is a helper method to define mock.On call
//   - user domain.User
func (_e *MockUserRepository_Expecter) Save(user any) *MockUserRepository_Save_Call {
	return &MockUserRepository_Save_Call{Call: _e.mock.On("Save", user)}
}

func (_c *MockUserRepository_Save_Call) Run(run func(user domain.User)) *MockUserRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUserRepository_Save_Call) RunAndReturn(run func(user domain.User) error) *MockUserRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
